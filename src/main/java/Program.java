...
public class Program {
    public static void main(String[] args) {
       List<PVTPoint> originPointList;
        ...
        originPointList.add(new PVTPoint(new Double[] {500.0, 1100.0, 300.0, 250.0, 500.0, 350.0}, new Double[] {25.0, 60.0, 35.0, 250.0, 100.0, 350.0}));
        originPointList.add(new PVTPoint(new Double[] {600.0, 1300.0, 350.0, 300.0, 600.0, 400.0}, new Double[] {30.0, 70.0, 40.0, 300.0, 110.0, 400.0}));
        originPointList.add(new PVTPoint(new Double[] {700.0, 1500.0, 400.0, 350.0, 700.0, 450.0}, new Double[] {35.0, 80.0, 45.0, 350.0, 120.0, 450.0}));
        originPointList.add(new PVTPoint(new Double[] {800.0, 1700.0, 450.0, 400.0, 800.0, 500.0}, new Double[] {40.0, 90.0, 50.0, 400.0, 130.0, 500.0}));
